Julia является гомоиконическим языком программирования: программы представляются как структуры данных самого языка. Фактически, всё является выражением `Expr`.
